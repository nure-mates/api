...
MIGRATE=migrate -path migrations/migrate_sql -database postgres://postgres:12345@localhost:5432/mates-db?sslmode=disable
TEST_MIGRATE=migrate -path migrations/migrate_sql  -database postgres://postgres:12345@localhost:5432/mates-db-test?sslmode=disable
